...
const INTL_OVERRIDES: Record<string, { from?: number; to?: number }> = {
  ...
  michael_ricketts:  { from: 2001, to: 2003 },
  francis_jeffers:   { from: 2001, to: 2004 },
  kieran_richardson: { from: 2005, to: 2007 },
  luke_young:        { from: 2005, to: 2008 },
  jermaine_pennant:  { from: 2005, to: 2008 },
  andrew_johnson:    { from: 2005, to: 2008 },
  joey_barton:       { from: 2006, to: 2008 },
  darren_bent:       { from: 2006, to: 2011 },
  dean_ashton:       { from: 2006, to: 2009 },
  carlton_cole:      { from: 2008, to: 2010 },
  jay_bothroyd:      { from: 2010, to: 2011 },
  bobby_zamora:      { from: 2010, to: 2011 },
  adam_johnson:      { from: 2010, to: 2012 },
  tom_huddlestone:   { from: 2009, to: 2013 },
  jack_rodwell:      { from: 2011, to: 2013 },
  tom_cleverley:     { from: 2012, to: 2014 },
  leon_osman:        { from: 2012, to: 2013 },
  rickie_lambert:    { from: 2013, to: 2014 },
  andros_townsend:   { from: 2013, to: 2016 },
  jonjo_shelvey:     { from: 2012, to: 2016 },
  wilfried_zaha:     { from: 2012, to: 2013 },
  saido_berahino:    { from: 2014, to: 2016 },
  charlie_austin:    { from: 2015, to: 2016 },
  mark_noble:        { from: 2009, to: 2016 },
  michail_antonio:   { from: 2016, to: 2017 },
  troy_deeney:       { from: 2015, to: 2018 },
  nathaniel_clyne:   { from: 2014, to: 2017 },
  harry_winks:       { from: 2017, to: 2020 },
  lewis_cook:        { from: 2017, to: 2019 },
  james_tarkowski:   { from: 2018, to: 2023 },
  james_maddison:    { from: 2019, to: 2024 },
  james_ward_prowse: { from: 2017, to: 2023 },
  fikayo_tomori:     { from: 2019, to: 2023 },
  ivan_toney:        { from: 2022, to: 2025 },
  patrick_bamford:   { from: 2021, to: 2022 },
  jarrod_bowen:      { from: 2022, to: 2026 },
  dominic_solanke:   { from: 2017, to: 2026 },
  ben_white:         { from: 2021, to: 2022 },
  conor_gallagher:   { from: 2021, to: 2026 },
  angel_gomes:       { from: 2024, to: 2026 },
  adam_wharton:      { from: 2024, to: 2026 },
  morgan_rogers:     { from: 2024, to: 2026 },
}
